...
async def start(c, m):
    ...
    await m.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('📌  Support Group', url='https://t.me/MinionBotsSupport'),
                    InlineKeyboardButton('🔖  Projects Channel', url='https://t.me/MinionBots')
                ],
                [
                    InlineKeyboardButton('💡  Source Code', url='https://github.com'),
                    InlineKeyboardButton('👨  Master', url='https://t.me/abtmesk')
                ]
            ]
        )
    )
